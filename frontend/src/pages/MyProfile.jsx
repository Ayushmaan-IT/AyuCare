    ...
    userData && (
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        ...
        <div className="mt-10">
          {isEdit ? (
            <button
              className="border border-black px-8 py-2 rounded-full text-black hover:bg-gradient-to-r
hover:from-sky-300 hover:to-blue-800 
transition-all duration-300 cursor-pointer"
 ...
 text-black hover:bg-gradient-to-r hover:from-sky-400 hover:to-blue-700
transition-all duration-300 cursor-pointer"
